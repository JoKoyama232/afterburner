...
static INTERPOLATION_DATA g_MoveTbl0[] = {
	//座標									回転率							拡大率							時間
	{ XMFLOAT3(50.0f,  50.0f, 0.0f),	XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(1.0f, 1.0f, 1.0f),			30 },
	{ XMFLOAT3(250.0f,  50.0f, 0.0f),	XMFLOAT3(0.0f, 0.0f, 31.4f),		XMFLOAT3(1.0f, 1.0f, 1.0f),			60 },
	{ XMFLOAT3(100.0f, 200.0f, 0.0f),	XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(0.5f, 0.5f, 1.0f),			30 },
	{ XMFLOAT3(150.0f, 0.0f, 0.0f),		XMFLOAT3(0.0f, 0.0f, 31.4f),		XMFLOAT3(1.0f, 1.0f, 1.0f),			60 },
	{ XMFLOAT3(200.0f, 200.0f, 0.0f),	XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(0.5f, 0.5f, 1.0f),			30 },
};
